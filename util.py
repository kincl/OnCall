...
from api.models import Event, Schedule
...
def _get_monday(input_date):
    if input_date.isoweekday() == current_app.config['ONCALL_START']:
        return input_date
    else:
        return _get_monday(input_date - ONE_DAY)
